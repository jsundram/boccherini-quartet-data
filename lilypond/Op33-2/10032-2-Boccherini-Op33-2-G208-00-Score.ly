\version "2.24.1"
\include "10032-2-Boccherini-Op33-2-G208-Global.ily"
...
\new StaffGroup	<< 		
			\new Staff \with { instrumentName = "Violon I" }
					<<	\keepWithTag #'mvtI {\include "10032-2-Boccherini-Op33-2-G208-Trame.ily"}
							\keepWithTag #'score \include "10032-2-01-V1-1.ily"
					>>
			\new Staff \with { instrumentName = "Violon II"}
					<<	\keepWithTag #'mvtI {\include "10032-2-Boccherini-Op33-2-G208-Trame.ily"}
							\keepWithTag #'score \include "10032-2-02-V2-1.ily"
					>>
			\new Staff \with { instrumentName = "Alto"}
					<<	\keepWithTag #'mvtI {\include "10032-2-Boccherini-Op33-2-G208-Trame.ily"}
							\keepWithTag #'score \include "10032-2-03-A-1.ily"
					>>
			\new Staff \with { instrumentName = "Violoncelle"}
					<<	\keepWithTag #'mvtI {\include "10032-2-Boccherini-Op33-2-G208-Trame.ily"}
							\keepWithTag #'score \include "10032-2-04-Vc-1.ily"
					>>
	>>
...
\new StaffGroup	<< 		
			\new Staff 
					<<	\keepWithTag #'mvtII {\include "10032-2-Boccherini-Op33-2-G208-Trame.ily"}
							\keepWithTag #'score \include "10032-2-01-V1-2.ily"
					>>
			\new Staff 
					<<	\keepWithTag #'mvtII {\include "10032-2-Boccherini-Op33-2-G208-Trame.ily"}
							\keepWithTag #'score \include "10032-2-02-V2-2.ily"
					>>
			\new Staff 
					<<	\keepWithTag #'mvtII {\include "10032-2-Boccherini-Op33-2-G208-Trame.ily"}
							\keepWithTag #'score \include "10032-2-03-A-2.ily"
					>>
			\new Staff 
					<<	\keepWithTag #'mvtII {\include "10032-2-Boccherini-Op33-2-G208-Trame.ily"}
							\keepWithTag #'score \include "10032-2-04-Vc-2.ily"
					>>
	>>
