...
%%%% 	v.1: juillet 2023
%%%%  édité par M. Leménager  philhar1825@orange.fr

cTitre = \markup { "46" \super "ème" "Quatuor" }
cSousTitre = "op.32 n°4 - G.204"
cCompositeur =	"Luigi BOCCHERINI"
cDates = "(1743-1805)"
cCompositeurDates = \markup {\center-column {\cCompositeur \cDates}}
cSource = \markup {\fontsize #-2 "Source: Artaria, Vienne ca.1781 (IMSLP)"}
cRefConcert = "10031-4"
cCopyright = \markup {\abs-fontsize #5 \concat {
				\epsfile #X #2  #"cc.eps"  " 2023-" \italic {"Le Concert - "} \cRefConcert " / " \cCompositeur " - " \cTitre " - v.1" }}
...
dolcemo = \markup {\italic "dolcissimo"}
rf = #(make-dynamic-script "rf")
ten = \markup {\italic "ten."}
crescpoc = _\markup {\italic "cresc. un poco"}
soave = \markup {\italic "Soave"}
pf = _\markup {\right-align {\italic "p" \dynamic f}}			% #(make-dynamic-script "pf")
%{
smorz = \markup {\italic "Smorz."}
manc = \markup {\italic "mancando"}
stacc = \markup {\italic "stacc."}
sottoVoce = _\markup {\italic "Sotto voce"}
crescpocoa = _\markup {\italic "cresc. poco a poco"}
...
tsUp = \textSpannerUp
tsDown = \textSpannerDown
tsOn = \startTextSpan
tsOff = \stopTextSpan

clefReprise = \once \override Score.BreakAlignment.break-align-orders = #(make-vector 3 '( staff-bar clef key-signature ))
