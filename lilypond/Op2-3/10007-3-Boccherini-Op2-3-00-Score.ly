...
\new StaffGroup	<< 		
			\new Staff \with {
					...
					<<	\keepWithTag #'mvtI {\include "10007-3-Boccherini-Op2-3-Trame.ily"}
							\keepWithTag #'score \include "10007-3-01-V1-1.ily"
					>>
			\new Staff \with {
					instrumentName = "Violon II"}
					<<	\keepWithTag #'mvtI {\include "10007-3-Boccherini-Op2-3-Trame.ily"}
							\keepWithTag #'score \include "10007-3-02-V2-1.ily"
					>>
			\new Staff \with {
					instrumentName = "Alto"}
					<<	\keepWithTag #'mvtI {\include "10007-3-Boccherini-Op2-3-Trame.ily"}
							\keepWithTag #'score \include "10007-3-03-A-1.ily"
					>>
			\new Staff \with {
					instrumentName = "Violoncelle"}
					<<	\keepWithTag #'mvtI {\include "10007-3-Boccherini-Op2-3-Trame.ily"}
							\keepWithTag #'score \include "10007-3-04-Vc-1.ily"
					>>
	>>
...
\new StaffGroup	<< 		
			\new Staff 
					<<	\keepWithTag #'mvtII {\include "10007-3-Boccherini-Op2-3-Trame.ily"}
							\keepWithTag #'score \include "10007-3-01-V1-2.ily"
					>>
			\new Staff 
					<<	\keepWithTag #'mvtII {\include "10007-3-Boccherini-Op2-3-Trame.ily"}
							\keepWithTag #'score \include "10007-3-02-V2-2.ily"
					>>
			\new Staff 
					<<	\keepWithTag #'mvtII {\include "10007-3-Boccherini-Op2-3-Trame.ily"}
							\keepWithTag #'score \include "10007-3-03-A-2.ily"
					>>
			\new Staff 
					<<	\keepWithTag #'mvtII {\include "10007-3-Boccherini-Op2-3-Trame.ily"}
							\keepWithTag #'score \include "10007-3-04-Vc-2.ily"
					>>
	>>
...
\new StaffGroup	<< 		
			\new Staff 
					<<	\keepWithTag #'mvtIII {\include "10007-3-Boccherini-Op2-3-Trame.ily"}
							\keepWithTag #'score \include "10007-3-01-V1-3.ily"
					>>
			\new Staff 
					<<	\keepWithTag #'mvtIII {\include "10007-3-Boccherini-Op2-3-Trame.ily"}
							\keepWithTag #'score \include "10007-3-02-V2-3.ily"
					>>
			\new Staff 
					<<	\keepWithTag #'mvtIII {\include "10007-3-Boccherini-Op2-3-Trame.ily"}
							\keepWithTag #'score \include "10007-3-03-A-3.ily"
					>>
			\new Staff 
					<<	\keepWithTag #'mvtIII {\include "10007-3-Boccherini-Op2-3-Trame.ily"}
							\keepWithTag #'score \include "10007-3-04-Vc-3.ily"
					>>
	>>
