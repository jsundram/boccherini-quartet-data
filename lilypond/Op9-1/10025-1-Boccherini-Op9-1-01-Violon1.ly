...
\score {		%%1er mvt
	...
	{ \silencesMulti
		<<	\keepWithTag #'mvtI {\include "10025-1-Boccherini-Op9-1-Trame.ily"}
				\keepWithTag #'partie {\include "10025-1-01-V1-1.ily"}
		>>
	}
}	%% fin score 1er mvt
...
\score {		%%2e mvt
	...
	{ \silencesMulti
		<<	\keepWithTag #'mvtII {\include "10025-1-Boccherini-Op9-1-Trame.ily"}
				\keepWithTag #'partie \include "10025-1-01-V1-2.ily"
		>>
	}
} %%	 fin score 2e mvt
...
\score {		%%3e mvt
	...
	{ \silencesMulti
		<<	\keepWithTag #'mvtIII {\include "10025-1-Boccherini-Op9-1-Trame.ily"}
				\keepWithTag #'partie \include "10025-1-01-V1-3.ily"
		>>
	}
} %%	 fin score 3e mvt
\pageBreak
\score {		%%4e mvt
	...
	{ \silencesMulti
		<<	\keepWithTag #'mvtIV {\include "10025-1-Boccherini-Op9-1-Trame.ily"}
				\keepWithTag #'partie \include "10025-1-01-V1-4.ily"
		>>
	}
} %%	 fin score 4e mvt
