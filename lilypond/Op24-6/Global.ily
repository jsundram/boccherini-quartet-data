...
cTitre = \markup { "36" \super "ème" "Quatuor" }
cSousTitre = "op.24 n°6 - G.194"
cCompositeur =	"Luigi BOCCHERINI"
cDates = "(1743-1805)"
cCompositeurDates = \markup {\center-column {\cCompositeur \cDates}}
cSource = \markup {\fontsize #-2 "Source: Manuscrit autographe 1777 (Gallica-BNF)"}
cRefConcert = "10028-6"
...
piuf = _\markup {\right-align {\italic "più" \dynamic f}}
ten = \markup {\italic "ten."}
%{
espr = \markup {\italic "espressivo."}
crescpocopoco = _\markup {\italic "cresc.  poco  a  poco "}
