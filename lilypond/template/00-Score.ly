...
% Full conductor's score. One \score block per movement; each movement reads
% the shared skeleton (Trame.ily, tag #'mvtN) plus the four part files
% (tag #'score). To add a 4th movement, copy a \score block, bump the roman
% numeral and the -N file suffixes, and add \tag #'mvtIV to Trame.ily.
