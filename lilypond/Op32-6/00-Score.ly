...
\new StaffGroup	<< 		
			\new Staff 
					<<	\keepWithTag #'mvtIV {\include "Trame.ily"}
							\keepWithTag #'score \include "01-V1-4.ily"
					>>
			\new Staff 
					<<	\keepWithTag #'mvtIV {\include "Trame.ily"}
							\keepWithTag #'score \include "02-V2-4.ily"
					>>
			\new Staff 
					<<	\keepWithTag #'mvtIV {\include "Trame.ily"}
							\keepWithTag #'score \include "03-A-4.ily"
					>>
			\new Staff 
					<<	\keepWithTag #'mvtIV {\include "Trame.ily"}
							\keepWithTag #'score \include "04-Vc-4.ily"
					>>
	>>
