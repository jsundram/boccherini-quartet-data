...
\score {		%%1er mvt
	...
	{ \silencesMulti
		<<	\keepWithTag #'mvtI {\include "10031-6-Boccherini-Op32-6-G206-Trame.ily"}
			\keepWithTag #'partie {\include "10031-6-03-A-1.ily"}
		>>
	}
}	%% fin score 1er mvt
...
\score {		%%2e mvt
	...
	{ \silencesMulti
		<<	\keepWithTag #'mvtII {\include "10031-6-Boccherini-Op32-6-G206-Trame.ily"}
				\keepWithTag #'partie \include "10031-6-03-A-2.ily"
		>>
	}
} %%	 fin score 2e mvt
\pageBreak
\score {		%%3e mvt
	...
	{ \silencesMulti
		<<	\keepWithTag #'mvtIII {\include "10031-6-Boccherini-Op32-6-G206-Trame.ily"}
				\keepWithTag #'partie \include "10031-6-03-A-3.ily"
		>>
	}
} %%	 fin score 3e mvt
...
\score {		%%4e mvt
	...
	{ \silencesMulti
		<<	\keepWithTag #'mvtIV {\include "10031-6-Boccherini-Op32-6-G206-Trame.ily"}
				\keepWithTag #'partie \include "10031-6-03-A-4.ily"
		>>
	}
} %%	 fin score 4e mvt
