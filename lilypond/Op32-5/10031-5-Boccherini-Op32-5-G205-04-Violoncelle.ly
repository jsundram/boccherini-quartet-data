...
\score {		%%1er mvt
	...
	{ \silencesMulti
		<<	\keepWithTag #'mvtI {\include "10031-5-Boccherini-Op32-5-G205-Trame.ily"}
			\keepWithTag #'partie {\include "10031-5-04-Vc-1.ily"}
		>>
	}
}	%% fin score 1er mvt
...
\score {		%%2e mvt
	...
	{ \silencesMulti
		<<	\keepWithTag #'mvtII {\include "10031-5-Boccherini-Op32-5-G205-Trame.ily"}
				\keepWithTag #'partie \include "10031-5-04-Vc-2.ily"
		>>
	}
} %%	 fin score 2e mvt
...
\score {		%%3e mvt
	...
	{ \silencesMulti
		<<	\keepWithTag #'mvtIII {\include "10031-5-Boccherini-Op32-5-G205-Trame.ily"}
				\keepWithTag #'partie \include "10031-5-04-Vc-3.ily"
		>>
	}
} %%	 fin score 3e mvt
\pageBreak
\score {		%%4e mvt
	...
	{ \silencesMulti
		<<	\keepWithTag #'mvtIV {\include "10031-5-Boccherini-Op32-5-G205-Trame.ily"}
				\keepWithTag #'partie \include "10031-5-04-Vc-4.ily"
		>>
	}
} %%	 fin score 4e mvt
